...
#############################################
#identifies differences between board states#
#############################################
# define example 2D arrays
...
#########################################################################################################
#Given New FEN, Translate that into MOF
############################################################################################################################
...
with open(r"C:\Users\youss\trial\Text Files\boardstate.txt", "w") as f:
    for i in range(8):
        for j in range(8):
            ...
            f.write(' ')
        f.write('\n')
with open(r"C:\Users\youss\trial\Text Files\prevboardstate.txt", "w") as f:
    for i in range(8):
        for j in range(8):
            f.write(str(boardState[i][j]))
            f.write(' ')
